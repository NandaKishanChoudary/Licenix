...
let AiAdvisorService = class AiAdvisorService {
     ...
     */
    async getClaudeRecommendations(input, apiKey) {
     ...
     */
    getHeuristicRecommendations(input) {
        ...
        const hasLicense = (id) => licenses.some((l) => l.id === id);
...
AiAdvisorService = __decorate([
    Injectable({ deps: [ConfigService] }),
    __metadata("design:paramtypes", [ConfigService])
], AiAdvisorService);
export { AiAdvisorService };
