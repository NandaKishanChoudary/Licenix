...
export const ALL_LICENSES: LicenseCatalogItem[] = [
  {
    id: 'trade-license',
    name: 'Trade License',
    mandatory: true,
...
export const SECTOR_LICENSES: Record<string, string[]> = {
  restaurant: [
    'trade-license',
    'fssai',
    'gst',
...
export const RESTAURANT_LICENSES = ALL_LICENSES.filter(l => 
  SECTOR_LICENSES.restaurant.includes(l.id)
);
