...
import { ALL_LICENSES, GOVERNMENT_DEPARTMENTS, SECTOR_LICENSES } from '../data/restaurant-license-catalog.js';
...
export class DocumentService {
   ...
   */
  async getForms(analysis: BusinessAnalysis): Promise<LicenseForm[]> {
   ...
   */
  private async getFormForLicense(licenseId: string, licenseName: string): Promise<LicenseForm> {
